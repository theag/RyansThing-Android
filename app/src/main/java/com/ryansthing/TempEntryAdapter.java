...
public class TempEntryAdapter extends BaseAdapter {

    private ArrayList<TempEntry> entries;
    private Context context;
    private AdapterInteractionListener listener;

    public TempEntryAdapter(Context context, ArrayList<TempEntry> entries) {
    ...
    @Override
    public TempEntry getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        TempEntry entry = getItem(position);
